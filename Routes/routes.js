...
router.get('/downloadpdf/:id', async (req, res) => {
    try {
        ...
        const totaldeduct = parseFloat(employee.pf) +
            ...
            parseFloat(employee.nats); // 👈 Add this
  ...
  #logo {
    ...
    display: block;
        ...
        <img src="https://res.cloudinary.com/dldubddug/image/upload/v1743750611/Datavalley_logo_Black-text_1_jkrc7y.jpg" alt="Company Logo" id="logo">
          ...
          <!-- Company Details -->
          <h3>DATAVALLEY INDIA PRIVATE LIMITED</h3>
          <p>Fortune Heights, 52-1 / 8-11, Plot No's-8 & 9, Road No-2, ESI Rd, beside Hotel Park N</p>
          <p>NTR Colony, Vijayawada, Andhra Pradesh 520008</p>
